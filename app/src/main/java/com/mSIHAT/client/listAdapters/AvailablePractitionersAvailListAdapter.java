 ...
 */
public class AvailablePractitionersAvailListAdapter extends BaseAdapter {

    List<PractitionerAvail> practitioners = null;
    Context context;
    private static LayoutInflater inflater = null;

    public AvailablePractitionersAvailListAdapter(Context context, List<PractitionerAvail> practitioners){
