...
public class CountryDetails {
    ...
    public static CharSequence[] country = new CharSequence[]{"Afghanistan", "Albania", "Algeria", "American Samoa", "Andorra", "Angola", "Anguilla",
    ...
    public static CharSequence[] getCountry() {
        return country;
    }
